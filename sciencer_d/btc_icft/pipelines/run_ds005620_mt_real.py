...
from sciencer_d.btc_icft.evaluation.ds005620_residual import (
    build_mock_ds005620_level_t_rows, build_mock_ds005620_level_m_rows, join_level_m_and_t_rows,
    evaluate_mt_residual, write_mt_outputs
)
...
def main(argv=None):
    ...
    a=p.parse_args(argv)
    if not a.mock_fixture:
        print('Level M and Level T feature tables are required. Run run_ds005620_m_real and run_ds005620_t_real first or use --mock-fixture.',file=sys.stderr)
        return 1
